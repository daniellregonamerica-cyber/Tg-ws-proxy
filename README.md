...
Скрипт Worker'а для проксирования через собственный `workers.dev`-домен лежит в
[`cloudflare-worker/`](./cloudflare-worker) — инструкция по деплою и использованию там же.
